...
template "/etc/default/apache2" do
  source "default.erb"
  owner "root"
  group "root"
  mode 0644
...
include_recipe "apache2::mod_info"
...
include_recipe "apache2::mod_headers" if node[:apache][:block_range_header]
...
# let localhost display status stuff
template "#{node[:apache][:dir]}/sites-available/localhost" do
  source "localhost-site.erb"
  owner "root"
  group "root"
  mode 0644
  notifies :restart, resources(:service => "apache2"), :delayed
